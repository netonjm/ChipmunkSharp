...
namespace CocosSharp
{
	...
	public class CCMouse
	{
		...
		public CCMouse()
#else
		public CCMouse(b2Body mouseBody)
#endif
		{
#if USE_PHYSICS
			...
			this.mouseBody = mouseBody; // m_world.CreateBody(bodyDef);
...
#else
			Position = new b2Vec2(PositionPoint.X, PositionPoint.Y);
#endif
...
#endif
					//b2BodyDef bodyDef = new b2BodyDef();
					//_instance = new CCMouse(m_world.CreateBody(bodyDef));
...
#else
			if (mouseBody != null && Position != null && mouseJoint != null)
