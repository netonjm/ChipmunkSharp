...
namespace ChipmunkSharp
{
	...
	_space = space;
		...
		public void DebugDraw()
		{
			...
			DrawString(15, 50, string.Format("Bodies : {0}", _space.bodies.Count));
		...
		//	DrawPolygon(poly.verts, poly.Count, fill, poly.r, color);
		}
		...
		public void Draw(cpCircleShape circle, cpColor color)
		{
			...
			cpVect To = cpVect.cpvadd(cpVect.cpvmult(circle.body.Rotation, circle.r), (circle.tc));
