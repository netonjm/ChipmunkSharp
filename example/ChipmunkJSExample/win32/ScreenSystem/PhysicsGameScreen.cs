...
namespace ChipmunkExample
{
    public class PhysicsGameScreen : GameScreen
    {
        ...
        protected cpDebugDrawMG DebugView;
        protected cpSpace World;

        private float _agentForce;
        private float _agentTorque;
        private FixedMouseJoint _fixedMouseJoint;
        private cpBody _userAgent;
        ...
        protected void SetUserAgent(cpBody agent, float force, float torque)
        {
            _userAgent = agent;
            _agentForce = force;
            _agentTorque = torque;
        ...
        private void EnableOrDisableFlag(cpDrawFlags flag)
        {
