...
namespace ChipmunkExample
{
    public class Camera2D
    {
        ...
        private cpVect _currentPosition;

        private float _currentRotation;

        private float _currentZoom;
        private cpVect _maxPosition;
        private float _maxRotation;
        private cpVect _minPosition;
        private float _minRotation;
        private bool _positionTracking;
        private Matrix _projection;
        private bool _rotationTracking;
        private cpVect _targetPosition;
        private float _targetRotation;
        private cpBody _trackingBody;
        ...
        public Vector2 Position
        {
            ...
            set
            {
                ...
                {
                    _targetPosition = cpVect.Clamp(_targetPosition, _minPosition, _maxPosition);
                }
            }
        }
        ...
        {
            _currentPosition = cpVect.Zero;
            _targetPosition = cpVect.Zero;
            _minPosition = cpVect.Zero;
            _maxPosition = cpVect.Zero;
        ...
        public void Update(GameTime gameTime)
        {
            ...
            cpVect delta = _targetPosition - _currentPosition;
