...
namespace ChipmunkExample
{
    public class LineBatch : IDisposable
    {
        ...
        public void DrawLineShape(cpShape shape)
        {
            DrawLineShape(shape, Color.Black);
        }

        public void DrawLineShape(cpShape shape, Color color)
        {
            //if (!_hasBegun)
            //{
            //    throw new InvalidOperationException("Begin must be called before DrawLineShape can be called.");
            //}
            //if (shape.shapeType != cpShapeType.Edge &&
            //    shape.shapeType != cpShapeType.Loop)
            //{
            ...
            //    _lineVertsCount += 2;
            //}
            //else if (shape.shapeType == cpShapeType.Loop)
            //{
